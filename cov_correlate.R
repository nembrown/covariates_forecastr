...
ggsave(california_current_oceanic_Covariate_plots_stock, file=paste0("Plots/", modelstock, "/cali_current_oceanic_", year_match,"_", modelstock, "_Age_",age_class, ".tiff"))
}
...
if (!is.na(truncate_ts) & truncate_ts >=1998) {
  ggsave(california_current_temp_salinity_Covariate_plots_stock, file=paste0("Plots/", modelstock, "/cali_current_temp_sal_", year_match,"_", modelstock, "_Age_",age_class, ".tiff"))
}
...
if (!is.na(truncate_ts) & truncate_ts >=1998) {
  ggsave(california_current_zoop_Covariate_plots_stock, file=paste0("Plots/", modelstock, "/cali_current_zoop", year_match,"_", modelstock, "_Age_",age_class, ".tiff"))
}
...
if (!is.na(truncate_ts) & truncate_ts >=1998) {
  ggsave(california_current_salmon_Covariate_plots_stock, file=paste0("Plots/", modelstock, "/cali_current_salmon", year_match,"_", modelstock, "_Age_",age_class, ".tiff"))
}
